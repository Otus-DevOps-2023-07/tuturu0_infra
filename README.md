...
- Создан конфиг для создания ВМ при помощи Vagrant (xenial64 пришлось изменить на bionic64)
- Таски ролей app и db разнесены по нескольким файлам
- Параметризация роли app
- Установка и конфигурация Molecule
- Тестирование ролей средствами Molecule
...
## Файлы packer_app.yml и packer_db.yml - заглушки для прохождения теста. Оригинальные файлы находятся в каталоге playbooks
